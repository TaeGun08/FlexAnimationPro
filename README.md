...
최신 버전에서는 노드 기반의 그래프 에디터를 통해 더욱 복잡한 애니메이션 로직을 시각적으로 설계할 수 있습니다.

## ✨ 주요 특징

*   **노드 기반 그래프 에디터 (FlexAnimation Graph):** 복잡한 애니메이션 시퀀스와 상호작용 로직을 시각적으로 설계하고 관리할 수 있습니다. (`Window > Flex Animation Editor`)
...
## 🖼️ FlexAnimation Graph (노드 에디터)

시각적으로 애니메이션 흐름을 제어하려면 그래프 에디터를 사용하세요.

1.  프로젝트 창에서 우클릭: `Create > FlexAnimation > Graph`를 선택하여 그래프 에셋을 생성합니다.
2.  상단 메뉴: `Window > Flex Animation Editor`를 엽니다.
3.  생성한 그래프 에셋을 에디터 창에 할당하고 노드를 추가하여 애니메이션을 구성합니다.
